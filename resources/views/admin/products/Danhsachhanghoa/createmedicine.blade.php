        ...
        <div class="modal-body p-4">
            ...
            <ul class="nav nav-tabs border-0 mb-3" id="medicineTab" role="tablist">
                <li class="" role="presentation">
                            <button class="nav-link active px-4 py-2 fw-bold" id="info-tab" data-bs-toggle="tab" data-bs-target="#info" type="button" role="tab" style="margin-left:-25px;">Thông tin</button>
                </li>
                <li class="" role="presentation">
