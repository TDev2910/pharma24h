    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content" style="border-radius: 16px;">
            <div class="modal-header">
                <h5 class="modal-title" id="editGoodsModalLabel">
                    <i class="fas fa-edit me-2"></i>Chỉnh sửa hàng hóa
                </h5>
            ...
            <form id="editGoodsForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    <ul class="nav nav-tabs border-0 mb-3" id="editGoodsTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active px-4 py-2 fw-bold"
                                    id="edit-info-tab"
                                    data-bs-toggle="tab"
                    ...
                    <div class="tab-content" id="editGoodsTabContent">
                        <!-- Tab Thông tin -->
                        <div class="tab-pane fade show active" id="edit-info" role="tabpanel">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="border-2 border-dashed border-primary rounded-3 d-flex flex-column align-items-center justify-content-center position-relative bg-light"
                                         style="width: 200px; height: 200px; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);"
                                         id="edit-goods-image-preview-container">
                                        <input type="file"
                                               name="image"
                                               accept="image/*"
                                               style="opacity: 0; position: absolute; width: 100%; height: 100%; cursor: pointer; top: 0; left: 0; z-index: 1;"
                                               onchange="previewEditGoodsImage(this)">
                                        <div class="text-center" id="edit-goods-image-placeholder">
                                        ...
                                        <img id="edit-goods-image-preview"
                                            src=""
                                            alt="Preview"
                                ...
                                <div class="row g-3 mb-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                               ...
                                               id="goods_edit_quy_cach_dong_goi"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="position-relative">
                                            <select class="form-select"
                                                    ...
                                                    id="goods_edit_manufacturer_id"
                                                    onchange="handleEditManufacturerChange(this)">
                                            ...
                                            <!-- Inline form cho Manufacturer - EDIT GOODS -->
                                            <div id="editGoodsManufacturerInlineForm"
                                                 class="mt-2 p-3 border rounded bg-light"
                                                 style="display: none;">
                                                <div class="mb-2">
                                                    <input type="text"
                                                           class="form-control"
                                                           id="editNewGoodsManufacturerName"
                                                           placeholder="Nhập tên hãng sản xuất mới">
                                                </div>
                                                <div class="d-flex gap-2">
                                                    <button type="button"
                                                            class="btn btn-success"
                                                            onclick="createNewEditManufacturerInline()">
                                                        <i class="fas fa-save"></i> Lưu
                                                    </button>
                                                    <button type="button"
                                                            class="btn btn-secondary"
                                                            onclick="cancelEditManufacturerForm()">
                                ...
                                <div class="row g-3 mb-2">
                                    <div class="col-md-4">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div id="editGoodsPositionInlineForm"
                                                 class="mt-2 p-3 border rounded bg-light"
                                                 style="display: none;">
                                                <div class="mb-2">
                                                    <input type="text"
                                                           class="form-control"
                                                           id="editNewGoodsPositionName"
                                                           placeholder="Nhập tên vị trí mới">
                                                </div>
                                                <div class="d-flex gap-2">
                                                    <button type="button"
                                                            class="btn btn-success"
                                                            onclick="createNewEditPositionInline()">
                                                        <i class="fas fa-save"></i> Lưu
                                                    </button>
                                                    <button type="button"
                                                            class="btn btn-secondary"
                                                            onclick="cancelEditPositionForm()">
                                                        <i class="fas fa-times"></i> Hủy
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <div class="row g-3 mb-2">
                                    <div class="col-md-8">
                                        <input type="text"
                                               class="form-control"
                                               name="don_vi_tinh"
                                               id="goods_edit_don_vi_tinh_input"
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input"
                                       type="checkbox"
                                       id="goods_edit_ban_truc_tiep"
                                       name="ban_truc_tiep">
                                <label class="form-check-label" for="goods_edit_ban_truc_tiep">
                                    Bán trực tiếp
                                </label>
                            </div>
                        </div>
