  ...
  <div class="tab-content">
      ...
      <div class="form-row">
        ...
        <div class="form-column">
          ...
          <div class="form-field full-width">
            ...
            <InputText v-model="form.ten_thuoc" placeholder="Nhập tên thuốc" class="field-input" :class="{ 'p-invalid': form.errors.ten_thuoc }" />
    ...
    <div class="form-section" style="margin-top: 20px;">
      ...
      <div class="form-row three-columns">
        <div class="form-field">
          ...
          <InputText v-model="form.so_dang_ky" placeholder="Bắt buộc" class="field-input" :class="{ 'p-invalid': form.errors.so_dang_ky }" />
        ...
        <div class="form-field">
          ...
          <InputText v-model="form.hoat_chat" placeholder="Bắt buộc" class="field-input" :class="{ 'p-invalid': form.errors.hoat_chat }" />
        ...
        <div class="form-field">
          ...
          <InputText v-model="form.ham_luong" placeholder="Bắt buộc" class="field-input" :class="{ 'p-invalid': form.errors.ham_luong }" />
      ...
      <div class="form-row">
        <div class="form-field">
          ...
          <div class="input-group">
            <Dropdown v-model="form.drugusage_id" :options="drugRouteOptions" optionLabel="name" optionValue="id" placeholder="Bắt buộc" class="field-input" :class="{ 'p-invalid': form.errors.drugusage_id }" />
            <Button icon="pi pi-cog" @click="$emit('open-drug-route-modal')" severity="secondary" size="small" title="Quản lý" />
          </div>
        ...
        <div class="form-field">
          ...
          <div class="input-group">
            ...
            <Button icon="pi pi-cog" @click="$emit('open-manufacturer-modal')" severity="secondary" size="small" title="Quản lý" />
          </div>
          <small class="text-muted">Thêm/Sửa/Xóa thực hiện trong cửa sổ quản lý.</small>
      ...
      <div class="form-row">
        <div class="form-field">
          ...
          <div class="input-group">
            ...
            <Button icon="pi pi-cog" @click="$emit('open-position-modal')" severity="secondary" size="small" title="Quản lý" />
          </div>
          <small class="text-muted">Thêm/Sửa/Xóa thực hiện trong cửa sổ quản lý.</small>
    ...
    <div class="form-section">
      ...
      <div class="form-row">
        ...
        <div class="form-field">
          <Button label="Thiết lập" @click="$emit('open-unit-modal')" severity="secondary" class="w-full" />
        </div>
      </div>
    </div>
...
defineProps({
  ...
  drugRouteOptions: { type: Array, default: () => [] },
