  ...
  <div class="page-wrapper">
    ...
    <div class="contact-banner">
      <div class="container">
        ...
        <p class="text-secondary">Hãy liên hệ với chúng tôi để hỏi thông tin, thông tin y tế hoặc cơ hội hợp tác.</p>
      </div>
    </div>
        ...
        <div class="col-lg-5">
          <div class="info-sidebar">
            ...
            <div class="specific-contacts">
              <p class="mb-2">Thông tin y tế: <a href="mailto:medinfo@pharmapct.vn">medinfo@pharmapct.vn</a></p>
              <p class="mb-2">Quan hệ nhà đầu tư: <a href="mailto:investors@pharmapct.vn">investors@pharmapct.vn</a></p>
              <p class="mb-2">Tuyển dụng: <a href="mailto:careers@pharmapct.vn">careers@pharmapct.vn</a></p>
            </div>
