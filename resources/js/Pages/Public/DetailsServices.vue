      ...
      <form @submit.prevent="submitBooking">
        <div class="form-grid">
          ...
          <div class="form-field">
            ...
            <InputText id="customer_name" v-model="bookingForm.customer_name" type="text" placeholder="Nhập họ và tên"
              class="field-input" :class="{ 'p-invalid': errors.customer_name }" required />
          ...
          <div class="form-field">
            ...
            <InputText id="customer_phone" v-model="bookingForm.customer_phone" type="tel"
              placeholder="Nhập số điện thoại" class="field-input" :class="{ 'p-invalid': errors.customer_phone }"
              required />
          ...
          <div class="form-field">
            ...
            <input id="booking_time" v-model="bookingForm.booking_time" type="time" required class="field-input"
...
/* Button Primary Styles - Màu xanh đậm mặc định, không hover */
.btn-primary,
button.btn-primary,
.btn.btn-primary {
