  ...
  <div class="modal-backdrop" @click.self="closeModal">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h3 class="modal-title">Tạo thuốc</h3>
      ...
      <div class="modal-body">
        <div class="form-container">
          ...
          <div class="form-field">
            ...
            <InputText v-model="formData.ten_thuoc" placeholder="Nhập tên hàng" class="field-input"
  ...
  methods: {
    ...
    async saveMedicine(event) {
      ...
      try {
        ...
        // Chỉ append các trường cần thiết
        ...
        if (this.formData.ten_thuoc) formData.append('ten_thuoc', this.formData.ten_thuoc)
