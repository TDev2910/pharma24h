       ...
       <div v-if="activeTab === 'info'" class="tab-content">
           ...
           <div class="form-row">
             ...
             <div class="form-column">
               ...
               <div class="form-field full-width">
                 <label class="field-label">Tên thuốc</label>
                 <InputText
               ...
               <div class="form-row">
                 ...
                 <div class="form-field">
                   <label class="field-label">Nhóm hàng</label>
                     ...
                     <div class="category-input-container" @click="toggleCategoryDropdown">
                       <div class="category-input">
                         ...
                         <input 
                           ...
                           :placeholder="selectedCategoryName || 'Chọn nhóm hàng'"
                           readonly
         ...
         <div class="form-section" style="margin-top: 20px;" >
           ...
           <div class="form-row three-columns">
             <div class="form-field">
               <label class="field-label">Số đăng ký</label>
               <InputText
             ...
             <div class="form-field">
               <label class="field-label">Hoạt chất</label> 
               <InputText
             ...
             <div class="form-field">
               <label class="field-label">Hàm lượng</label>
               <InputText
           ...
           <div class="form-row">
             <div class="form-field">
               <label class="field-label">Đường dùng</label>
               <div class="input-group">
                 <Dropdown
           ...
           <div class="form-row">
             <div class="form-field">
               <label class="field-label">Quy cách đóng gói</label>
               <InputText
   ...
   visible(newVal) {
     if (newVal) {
       ...
       if (this.medicineData) {
         this.loadMedicineData(this.medicineData)
       }
     }
   },
   medicineData: {
   ...
   closeModal() {
    ...
    async saveMedicine(event) {
      ...
      try {
        ...
        const response = await axios.post(`/admin/medicines/${this.medicineData.id}`, formData, {
          headers: {
       ...
       if (response.data.success) {
         ...
         this.$toast.add({
           severity: 'error',
           summary: 'Lỗi',
           detail: response.data.message || 'Có lỗi xảy ra khi cập nhật thuốc',
           life: 5000
         })
       }
       } catch (error) {
    ...
    loadMedicineData(medicineData) {
      this.formData = {
        ma_hang: medicineData.ma_hang || '',
        ma_vach: medicineData.ma_vach || '',
        ten_thuoc: medicineData.ten_thuoc || '',
        ten_viet_tat: medicineData.ten_viet_tat || '',
        nhom_hang_id: medicineData.nhom_hang_id || null,
        gia_von: medicineData.gia_von || 0,
        gia_ban: medicineData.gia_ban || 0,
        so_dang_ky: medicineData.so_dang_ky || '',
        hoat_chat: medicineData.hoat_chat || '',
        ham_luong: medicineData.ham_luong || '',
        drugusage_id: medicineData.drugusage_id || null,
        manufacturer_id: medicineData.manufacturer_id || null,
        quy_cach_dong_goi: medicineData.quy_cach_dong_goi || '',
        nuoc_san_xuat: medicineData.nuoc_san_xuat || '',
        ton_kho: medicineData.ton_kho || '0',
        ton_thap_nhat: medicineData.ton_thap_nhat || '',
        ton_cao_nhat: medicineData.ton_cao_nhat || '',
        position_id: medicineData.position_id || null,
        trong_luong: medicineData.trong_luong || 0,
      ...
      if (medicineData.nhom_hang_id) {
        this.selectedCategoryKeys = { [medicineData.nhom_hang_id.toString()]: true }
        this.selectedCategoryName = medicineData.nhom_hang_name || ''
      }
      
      // Load ảnh nếu có
      if (medicineData.image) {
        this.imagePreview = this.getImageUrl(medicineData.image)
      }
    },
    ...
    async onDrugRouteUpdated(newData) {
      ...
      try {
        ...
        if (newData && newData.id) {
          this.formData.drugusage_id = newData.id
        }
      } catch (error) {
