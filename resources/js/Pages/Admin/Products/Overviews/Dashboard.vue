  ...
  <div class="products-page">
      ...
      <div class="controls-section"
        ...
        <div class="ultility-options">
          ...
          <div class="dropdown" :class="{ 'show': showDropdown }">
            <Button icon="pi pi-plus" label="Tạo mới" @click="toggleDropdown" severity="secondary"
          ...
          <!-- Xuất file -->
          <Button icon="pi pi-upload" label="Xuất file" @click="exportFile" severity="secondary"
    ...
    <div class="main-content">
      ...
      <div class="right-content">
        <DataTable :value="filteredProducts" v-model:expandedRows="expandedRows" stripedRows responsiveLayout="scroll"
