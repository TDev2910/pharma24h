<template>
  <Dialog :visible="visible" @update:visible="(val) => $emit('update:visible', val)" header="Tạo thuốc"
    ...
    <div class="flex gap-6 form-grid">
      ...
      <div style="flex: 1;">
        ...
        <TabInfo v-show="activeTab === 'info'" :form="form" :selectedCategoryKey="selectedCategoryKey"
          :categoryTreeNodes="categoryTreeNodes" :drugRouteOptions="drugRouteOptions"
          :manufacturerOptions="manufacturerOptions" :positionOptions="positionOptions"
          @generate-code="generateMedicineCode" @generate-barcode="generateMedicineBarcode"
          @category-change="onCategoryChange" @open-unit-modal="showUnitModal = true"
          @open-drug-route-modal="showDrugRouteModal = true" @open-manufacturer-modal="showManufacturerModal = true"
    ...
    <UnitOfCalculation :visible="showUnitModal" @close="showUnitModal = false"
      @saved="(data) => form.don_vi_tinh = data.unitName" />
