<template>
  <div class="services-page">
          ...
          <div class="search-wrapper">
            <div class="input-group">
              ...
              <input type="text" class="form-control" style="border-radius:8px;"
                placeholder="Theo mã dịch vụ, tên dịch vụ" v-model="searchQuery" @input="debounceSearch">
            </div>
          </div>
        </div>
        <!-- Utility Options -->
    ...
    <div class="table-container">
      <DataTable :value="paginatedServices" dataKey="id" :paginator="false" :loading="loading" :pt="{
    ...
    <!-- Custom Paginator -->
    <Paginator :rows="10" :totalRecords="120" :rowsPerPageOptions="[5, 10, 20, 30]" style="margin-top: 50px;">
    </Paginator>
