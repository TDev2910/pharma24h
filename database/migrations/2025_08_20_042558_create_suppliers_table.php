...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('suppliers', function (Blueprint $table) {
            ...
            $table->string('ten_cong_ty,255')->unique()->comment('Tên công ty');
            $table->string('ma_so_thue',20)->unique()->comment('Mã số thuế');
            $table->enum('trang_thai',['hoat_dong','khong_hoat_dong'])->default('hoat_dong')->comment('Trạng thái');
