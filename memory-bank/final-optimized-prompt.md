# PROMPT CHUYÊN NGHIỆP - PHÂN TÍCH & TỐI ƯU DỰ ÁN PHẦN MỀM 
...
**🔧 STACK CÔNG NGHỆ:**
- Backend: [Laravel/PHP]
- Frontend: [Bootstrap, JavaScript, Blade Templates]
- Database: [MySQL]
- Others: [Specify any other technologies]

**📁 CÂU TRÚC THƯ MỤC:**
```
[Paste your project structure here - use tree command or file explorer]
```

**💻 MÃ NGUỒN CẦN PHÂN TÍCH:**
```php
[Paste the specific code files you want analyzed]
```

**🎯 BỐI CẢNH DỰ ÁN:**
- Loại dự án: [Web Application/API/E-commerce/etc.]
- Quy mô team: [Small/Medium/Large]
- Stage: [Development/Staging/Production]
- Vấn đề hiện tại: [Performance issues/Hard to maintain/etc.]
...
```
ADDITIONAL FOCUS cho Laravel projects:
- Eloquent relationships và query efficiency
- Service Container usage và binding
- Middleware implementation
- Blade component optimization
- Artisan command quality
...
```
ADDITIONAL FOCUS cho performance:
- Database indexing strategy
- Query caching với Redis
- HTTP caching headers
- Asset bundling với Vite
- Image optimization
...
```
ADDITIONAL FOCUS cho team work:
