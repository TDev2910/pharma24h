import {
  ...
  script2 as script10,
  script3 as script11
} from "./chunk-BCEG4B5P.js";
import {
  script as script5
} from "./chunk-PJTFH3R7.js";
import {
  script as script4
} from "./chunk-N7X5A7K4.js";
import {
  script as script6
} from "./chunk-6MRAFVTS.js";
import {
  script as script8
} from "./chunk-NKG3RG3C.js";
import {
  script as script7
} from "./chunk-E7ZFYJ5P.js";
import {
  script as script2
} from "./chunk-NSH6LOCZ.js";
import {
  script as script3
} from "./chunk-FY6X64MB.js";
import {
  Ripple
} from "./chunk-3E4MZSUQ.js";
import {
  script
} from "./chunk-7KR75YZX.js";
import {
  BaseStyle,
  C,
  Q,
...
var script$1 = {
  ...
  methods: {
    ...
    insertNodeOnDrop: function insertNodeOnDrop() {
      ...
      var subNodes2 = this.subNodes || [];
      var index = this.index || 0;
      var dropIndex = dragNodeSubNodes === subNodes2 ? dragNodeIndex > index ? index : index - 1 : index;
      dragNodeSubNodes.splice(dragNodeIndex, 1);
      if (position < 0) {
        subNodes2.splice(dropIndex, 0, dragNode);
      } else if (position > 0) {
        subNodes2.splice(dropIndex + 1, 0, dragNode);
      } else {
...
var script12 = {
    ...
    isFilterMatched: function isFilterMatched(node2, _ref) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
          ...
          var fieldValue = String(c(node2, field)).toLocaleLowerCase(this.filterLocale);
      ...
      if (dropScope !== null) {
        if (typeof dropScope === "string") {
          ...
          if (typeof dragScope === "string") {
            ...
            var _iterator3 = _createForOfIteratorHelper(dropScope), _step3;
            try {
  ...
  computed: {
    filteredValue: function filteredValue() {
      var filteredNodes = [];
      var searchFields = l(this.filterBy) ? [this.filterBy] : this.filterBy.split(",");
...
//# sourceMappingURL=chunk-L3JUH6G2.js.map
